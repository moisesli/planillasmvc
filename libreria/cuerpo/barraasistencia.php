  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="asistencia.php" class="nav-link" style="font-size: 20px; color:#0E048B"><strong>Inicio</strong></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
         <a href="periodoasiste.php" class="nav-link" style="font-size: 20px; color: #FB0716" title="Periodos"><strong>Periodo - <?php echo $miperiodo; ?></strong></a>
      </li>
