  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Empleados - Horario de Asistencia.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="asistencia.php">Inicio</a></li>
              <li class="breadcrumb-item active">Horario - Empleados</li>
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><a href="horarioempleado.php?micodigo=<?php echo intval($rowusuario['codigo'])?>" title="Horario"><button class="btn btn-success" type="button"><i class="nav-icon fas fa-clock"></i></button></a></td>
