<?php session_start();
	...
	$rscodliquidacion=$_POST['elcodliquidacion'];	
	...
	$rsregistro=$oLiquidacion->ModificarLiquidaciodatosn($rscodliquidacion,$txtapellidos,$txtdni,$txtcargo,$txtfechaini,$txtfechafin,$txttiempo,$txtfalta,$txtmotivo);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidacioncompua($rscodliquidacion,$txtsueldo,$txtasignacion,$txtcomision,$txtextras,$txtotro,$txtsexto,$totalcompu,$totalcompuotro);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidacioncts($rscodliquidacion,$txtctsmes,$txtctsdia,$totalctsmes,$totalctsdia,$totalcts);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidacionvaca($rscodliquidacion,$tiempocompu,$txtvacadiapen,$txtvacamesefec,$txtvacadiaefec,$txttotalvacadiapen,$txttotalmesefec,$txttotcavadiaefec,$totalvaca);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidaciongrati($rscodliquidacion,$txtgratimesefec,$txtgratibonopor,$tiempograti,$totalgratimesefec,$totalgratibono,$totalgrati);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidacionotros($rscodliquidacion,$txtotro1,$txtotro2,$txtotro3,$txtotro4,$totalotros);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidacionessalud($rscodliquidacion,$txtgratibonopor100,$totalesalud);
	...
	$rsregistro=$oLiquidacion->ModificarLiquidacionafp($rscodliquidacion,$poraporte,$afp1,$porprima,$afp2,$aporteafpcomi,$afp3,$poronp,$totalonp,$totaldctoafp);
