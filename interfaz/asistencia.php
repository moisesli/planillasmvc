...
// BUSCAR ULTIMA PLANILLA PROCESADA
	...
	$elmes=$rsplanillas["mes"];
	$elperiodo=$rsplanillas["periodo"];

	$ousuario=new Negocio_clsUsuario();
	$rsusuario=$ousuario->Contar_Registros('',$miempresa);				

	$rscontroles=$oplanilla->Listarcontrol($elperiodo,$elmes);
	$totaldescuentos=$rscontroles["totaldia"]+$rscontroles["tothor"]+$rscontroles["totmin"]; 
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="horario.php" class="small-box-footer">Lista de Trabajadores <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo 'S/. '.number_format($totaldescuentos,2); ?></h3>

                <p>Total Dctos. Planilla (<?php echo ucfirst(strtolower($rsplanillas["mes"])).' - '.$rsplanillas["periodo"]; ?>)</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="" class="small-box-footer">Total Descuentos </a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="" class="small-box-footer">Total Planilla </a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="" class="small-box-footer">Usuarios del Sistema</a>
            </div>
          </div>
          <!-- ./col -->
        </div>
