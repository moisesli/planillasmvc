         ...
         <div class="col-md-3">	
          ...
          <div class="col-md-6">
				...
				?>       
						<div class="card card-info">
						  <div class="card-header">
							<h3 class="card-title"><a href="cargo.php" title="Regresar"><button type="button" class="btn btn-tool" data-widget="remove"><i class="fas fa-times"></i></button></a>Cargo - Nuevo.</h3>                                
						  </div>

						  <form name="formulario" action="cargograbar.php?opcion=1" method="post">						   
							<div class="card-body">
							  <div class="row">
								<label class="col-sm-3 col-form-label">Nombre de Cargo</label>
								<div class="col-sm-9">
							...
							<div class="card-footer">
							  ...
							  <a href="cargo.php"><button type="button" class="btn btn-danger float-right">Cancelar</button></a>
							</div>                
						  </form>
						</div>  				
   				<?php
				...
				<?php
					...
					case 2:
						$micod=$_GET['micodigo'];
						$olistado=new Negocio_clsCargo();
						$rowusuario=$olistado->getROW($micod);
				?>          
						<div class="card card-info">
						  <div class="card-header">
							<h3 class="card-title"><a href="cargo.php" title="Regresar"><button type="button" class="btn btn-tool" data-widget="remove"><i class="fas fa-times"></i></button></a>Cargo - Modificar.</h3>                                
						  </div>

						  <form name="formulario" action="cargograbar.php?opcion=2" method="post">
						   <input type="hidden" name="txtcodigo" value="<?php echo $micod; ?>" class="ingreso" size="40"/>
							<div class="card-body">
							  <div class="row">
								<label class="col-sm-3 col-form-label">Nombre de Cargo</label>
								<div class="col-sm-9">
								  <input type="text" class="form-control" name="txtcargo" value="<?php echo $rowusuario['nombre']; ?>" required>
								</div>
							  </div>
							</div>
							<!-- /.card-body -->
