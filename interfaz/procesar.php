...
function seguro1() {
       if ( confirm("Seguro de Procesar la Planilla..?") ) {
            return true;
       } else {
             return false;
       }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Procesamiento de Planillas - Seleccione.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><a href="procesarplanilla.php?micodigo=<?php echo intval($rowusuario['codigo'])?>" title="Seleccionar"><button class="btn btn-success" type="button" onclick="return seguro1();"><i class="nav-icon fas fa-check"></i></button></a>
