  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Imprimir Descuentos - Seleccione.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><button class="btn btn-success" type="button" <?php echo $miok;?> onclick="javascript:AbrirCentrado('descuentosimprimirrep.php?micodigo=<?php echo $rowusuario['codigo'];?>&laopcion=1','','1024','600','');"><i class="nav-icon fas fa-print"></i></button></a>
