						...
						<div class="tab-content" id="custom-tabs-three-tabContent">
						  <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<input type="number" name="txtfaltas" min="1" max="31" value="<?php echo $rowCodigo['falta'];?>" class="form-control" autofocus>
								</div>
								<label class="col-sm-4 col-form-label"></label>
							  ...
							  <div class="row">
								<label class="col-sm-1 col-form-label"><?php echo $rowusuario['ingreso1']; ?></label>
									<?php
										if ($rowusuario['ingreso1'])
										{
											$op='readonly';
										}
										else
									...
									?>
								<div class="col-sm-3">							  	  
								  <input type="number" class="form-control" name="txtingreso1" value="<?php echo $rowTrabajador['sueldo'];?>" readonly>
								</div>
