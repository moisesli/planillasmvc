          ...
          <div class="col-md-10">
			...
			<div class="card card-info">
              <div class="card-header">
                <h3 class="card-title"><a href="creacion.php" title="Modificar"><button type="button" class="btn btn-tool" data-widget="remove"><i class="fas fa-times"></i></button></a>Creacion de Planillas - Modificar.</h3>                                
              </div>
						...
						<div class="tab-content" id="custom-tabs-three-tabContent">
						  <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
							...
							<div class="row">
								...
								<div class="col-sm-4">
								  <input type="number" class="form-control" value="1" name="txtnumero" value="<?php echo $rowplanilla['numero'];?>" required>
								</div>				
								<label class="col-sm-4 col-form-label"></label>
								...
								<div class="col-sm-4">
								  <input type="date" class="form-control" name="txtfechaini" value="<?php echo $rowplanilla['fini'];?>" required>
								</div>								
								<label class="col-sm-4 col-form-label"></label>
								...
								<div class="col-sm-4">
								  <input type="date" class="form-control" name="txtfechafin" value="<?php echo $rowplanilla['ffin'];?>" required>
								</div>								
								<label class="col-sm-4 col-form-label"></label>
							  </div>					  	  
							  ...
							  <div class="row">
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok2" id="txtok2" value="S" <?php if ($rowplanilla['ok2']=='S') echo 'checked';?>>
									<label for="txtok2">
									</label>
								  </div>
								</div>
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok3" id="txtok3" value="S"<?php if ($rowplanilla['ok3']=='S') echo 'checked';?>>
									<label for="txtok3">
									</label>
								  </div>
								</div>
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok4" id="txtok4" value="S" <?php if ($rowplanilla['ok4']=='S') echo 'checked';?>>
									<label for="txtok4">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok5" id="txtok5" value="S" <?php if ($rowplanilla['ok5']=='S') echo 'checked';?>>
									<label for="txtok5">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok6" id="txtok6" value="S" <?php if ($rowplanilla['ok6']=='S') echo 'checked';?>>
									<label for="txtok6">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok7" id="txtok7" value="S" <?php if ($rowplanilla['ok7']=='S') echo 'checked';?>>
									<label for="txtok7">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok8" id="txtok8" value="S" <?php if ($rowplanilla['ok8']=='S') echo 'checked';?>>
									<label for="txtok8">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok9" id="txtok9" value="S" <?php if ($rowplanilla['ok9']=='S') echo 'checked';?>>
									<label for="txtok9">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok10" id="txtok10" value="S" <?php if ($rowplanilla['ok10']=='S') echo 'checked';?>>
									<label for="txtok10">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok11" id="txtok11" value="S" <?php if ($rowplanilla['ok11']=='S') echo 'checked';?>>
									<label for="txtok11">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok12" id="txtok12" value="S" <?php if ($rowplanilla['ok12']=='S') echo 'checked';?>>
									<label for="txtok12">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok13" id="txtok13" value="S" <?php if ($rowplanilla['ok13']=='S') echo 'checked';?>>
									<label for="txtok13">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok14" id="txtok14" value="S" <?php if ($rowplanilla['ok14']=='S') echo 'checked';?>>
									<label for="txtok14">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok15" id="txtok15" value="S" <?php if ($rowplanilla['ok15']=='S') echo 'checked';?>>
									<label for="txtok15">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok16" id="txtok16" value="S" <?php if ($rowplanilla['ok16']=='S') echo 'checked';?>>
									<label for="txtok16">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok17" id="txtok17" value="S" <?php if ($rowplanilla['ok17']=='S') echo 'checked';?>>
									<label for="txtok17">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok18" id="txtok18" value="S" <?php if ($rowplanilla['ok18']=='S') echo 'checked';?>>
									<label for="txtok18">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok19" id="txtok19" value="S" <?php if ($rowplanilla['ok19']=='S') echo 'checked';?>>
									<label for="txtok19">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok20" id="txtok20" value="S" <?php if ($rowplanilla['ok20']=='S') echo 'checked';?>>
									<label for="txtok20">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok21" id="txtok21" value="S" <?php if ($rowplanilla['ok21']=='S') echo 'checked';?>>
									<label for="txtok21">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok22" id="txtok22" value="S" <?php if ($rowplanilla['ok22']=='S') echo 'checked';?>>
									<label for="txtok22">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok23" id="txtok23" value="S" <?php if ($rowplanilla['ok23']=='S') echo 'checked';?>>
									<label for="txtok23">
									</label>
								  </div>
								</div>								
								...
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok24" id="txtok24" value="S" <?php if ($rowplanilla['ok24']=='S') echo 'checked';?>>
									<label for="txtok24">
									</label>
								  </div>
								</div>								
						  ...
						  <div class="tab-pane fade" id="custom-tabs-three-laboral" role="tabpanel" aria-labelledby="custom-tabs-three-settings-tab">
							...
							<div class="card-body">
							  ...
							  <div class="row">
								<label class="col-sm-1 col-form-label">Ingreso 1</label>
								<div class="col-sm-2">							  	  
								  <input type="text" class="form-control" name="txtingreso1x" value="<?php echo $rowplanilla['ingreso1'];?>" readonly>
								</div>
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
								...
								<label class="col-sm-1 col-form-label">Ingreso 5</label>
								<div class="col-sm-2">
								  <input type="text" class="form-control" name="txtingreso5x" value="<?php echo $rowplanilla['ingreso5'];?>" readonly>
								</div>
								<div class="col-sm-1">							  	  								  
								 <div class="icheck-primary d-inline">
									<input type="checkbox" name="txtok5x" id="txtok5x" value="S" checked disabled>
									<label for="txtok5x">
									</label>
								  </div>
								</div>								
								...
								<label class="col-sm-2 col-form-label">IppsVida</label>
								<div class="col-sm-2">
								  <input type="text" class="form-control" name="txtippsvidax" value="<?php echo $rowplanilla['ipssvida'];?>" readonly>
								</div>
								<label class="col-sm-4 col-form-label"></label>
								...
								<label class="col-sm-2 col-form-label">Descuento 1</label>
								<div class="col-sm-2">
								  <input type="text" class="form-control" name="txtdescuento1x" value="<?php echo $rowplanilla['descuento1'];?>" readonly>
								</div>
								<label class="col-sm-4 col-form-label"></label>
								...
								<label class="col-sm-2 col-form-label">Descuento 2</label>
								<div class="col-sm-2">
								  <input type="text" class="form-control" name="txtdescuento2x" value="<?php echo $rowplanilla['descuento2'];?>" readonly>
								</div>
								<label class="col-sm-4 col-form-label"></label>
