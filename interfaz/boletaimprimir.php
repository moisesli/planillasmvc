  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Imprimir Boletas - Seleccione Planilla.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="administrador.php">Inicio</a></li>
              <li class="breadcrumb-item active">Seleccione Planilla</li>   
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><button class="btn btn-success" type="button" <?php echo $miok;?> onclick="javascript:AbrirCentrado('boletaimprimirrep.php?micodigo=<?php echo $rowusuario['codigo'];?>&laopcion=1','','1024','600','');"><i class="nav-icon fas fa-print"></i></button></a>
							
							<td align="center"><a href="boletaimprimiruno.php?micodigo=<?php echo $rowusuario['codigo'];?>"><button class="btn btn-success" type="button" <?php echo $miok;?> ><i class="nav-icon far fa-user"></i></button></a>
