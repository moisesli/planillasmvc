...
$oEntidad=new Negocio_clsConfiguracion();
$rsEntidad=$oEntidad->Buscar_Entidad($miempresa,$miperiodo);
$archivo='../plametrabajador/PT_'.$rsEntidad['ruc'].'.tra';
$fp=fopen($archivo,'w');
...
while($rowtrabajador=$rslistado->fetch_array())
{
	...
	if (substr($rowtrabajador['tipo'],0,2)<>'P11' and substr($rowtrabajador['tipo'],0,2)<>'P12' and substr($rowtrabajador['tipo'],0,2)<>'P13' and substr($rowtrabajador['tipo'],0,2)<>'P14')
	{
