  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Constancia de Haberes - Seleccione.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><button class="btn btn-warning" type="button" onclick="javascript:AbrirCentrado('haberesimprimirrep.php?micodigo=<?php echo $rowusuario['codigo'];?>&laopcion=1','','1024','600','');"><i class="nav-icon fas fa-print"></i></button></td>
						</tr>
                   <?php
						}  
					?>
