  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Liquidaciones - Trabajador.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><a href="liquidacionnuevo.php?micodigo=<?php echo intval($rowusuario['codigo'])?>" title="Seleccionar"><button class="btn btn-success" type="button"><i class="nav-icon fas fa-hand-holding"></i></button></a></td>
