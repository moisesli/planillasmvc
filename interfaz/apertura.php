        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Apertura de Asistencia</li>
              <li class="breadcrumb-item"><a href="aperturanuevo.php" title="Registrar"><button class="btn btn-success btn-sm" type="button">Aperturar Dia</button></a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					<?php					  
						...
						$rslistado=$olistado->Mostrar_Registros_Apertura();			
