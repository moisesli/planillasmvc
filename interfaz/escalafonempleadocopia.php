        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="escalafon.php">Empleados</li>
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><a href="trabajadorver.php?micodigo=<?php echo intval($rowusuario['codigo'])?>" title="Escaladon"><button class="btn btn-success" type="button"><i class="nav-icon far fa-copy"></i></button></a></td>
