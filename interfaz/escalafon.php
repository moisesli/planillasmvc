  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Empleados - Escalafon.</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <tbody>
					...
					?>                   
						...
						<tr>
							...
							<td align="center"><a href="escalafonempleado.php?micodigo=<?php echo intval($rowusuario['codigo'])?>" title="Escaladon"><button class="btn btn-success" type="button"><i class="nav-icon far fa-copy"></i></button></a></td>
